package com.drumbitious.backend.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.drumbitious.backend.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.drumbitious.backend.repository.UserRepository.USERS_BY_EMAIL_CACHE);
