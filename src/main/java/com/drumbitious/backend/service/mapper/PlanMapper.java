 ...
 */
@Mapper(componentModel = "spring", uses = {UserMapper.class, ExcerciseConfigMapper.class})
public interface PlanMapper extends EntityMapper<PlanDTO, Plan> {
    ...
    @Mapping(source = "excerciseConfig.id", target = "excerciseConfigId")
    PlanDTO toDto(Plan plan);

    @Mapping(source = "ownerId", target = "owner")
    @Mapping(source = "creatorId", target = "creator")
    @Mapping(source = "excerciseConfigId", target = "excerciseConfig")
