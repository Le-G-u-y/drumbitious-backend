...
public class PlanDTO implements Serializable {
    ...
    private Long excerciseConfigId;
    ...
    public Long getExcerciseConfigId() {
        return excerciseConfigId;
    }

    public void setExcerciseConfigId(Long excerciseConfigId) {
    ...
    public String toString() {
        return "PlanDTO{" +
            ...
            ", excerciseConfig=" + getExcerciseConfigId() +
            "}";
    }
}
