...
/**
 * Criteria class for the {@link com.drumbitious.backend.domain.ExerciseConfig} entity. This class is used
 * in {@link com.drumbitious.backend.web.rest.ExerciseConfigResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /exercise-configs?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ExerciseConfigCriteria implements Serializable, Criteria {
    ...
    public ExerciseConfigCriteria(){
    }

    public ExerciseConfigCriteria(ExerciseConfigCriteria other){
    ...
    @Override
    public ExerciseConfigCriteria copy() {
        return new ExerciseConfigCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ExerciseConfigCriteria that = (ExerciseConfigCriteria) o;
        return
