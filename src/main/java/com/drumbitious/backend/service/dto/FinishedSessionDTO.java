...
/**
 * A DTO for the {@link com.drumbitious.backend.domain.FinishedSession} entity.
 */
public class FinishedSessionDTO implements Serializable {
    ...
    public String getPlanPlanName() {
        return planPlanName;
    }

    public void setPlanPlanName(String planPlanName) {
        this.planPlanName = planPlanName;
    }
