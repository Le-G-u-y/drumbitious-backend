...
public class FinishedSession implements Serializable {
    ...
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<FinishedExcercise> excercises = new HashSet<>();
    ...
    public Set<FinishedExcercise> getExcercises() {
        return excercises;
    }

    public FinishedSession excercises(Set<FinishedExcercise> finishedExcercises) {
        this.excercises = finishedExcercises;
        return this;
    }

    public FinishedSession addExcercise(FinishedExcercise finishedExcercise) {
        this.excercises.add(finishedExcercise);
        finishedExcercise.setFinishedSession(this);
        return this;
    }

    public FinishedSession removeExcercise(FinishedExcercise finishedExcercise) {
        this.excercises.remove(finishedExcercise);
        finishedExcercise.setFinishedSession(null);
        return this;
    }

    public void setExcercises(Set<FinishedExcercise> finishedExcercises) {
        this.excercises = finishedExcercises;
    }
