...
import com.drumbitious.backend.repository.I18nTextRepository;
import com.drumbitious.backend.service.I18nTextService;
import com.drumbitious.backend.service.dto.I18nTextDTO;
import com.drumbitious.backend.service.mapper.I18nTextMapper;
...
public class I18nTextResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static I18nText createUpdatedEntity(EntityManager em) {
        I18nText i18nText = new I18nText()
    ...
    public void getAllI18nTexts() throws Exception {
        ...
        restI18nTextMockMvc.perform(get("/api/i-18-n-texts?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].textKey").value(hasItem(DEFAULT_TEXT_KEY)))
    ...
    public void getI18nText() throws Exception {
        ...
        restI18nTextMockMvc.perform(get("/api/i-18-n-texts/{id}", i18nText.getId()))
            ...
            .andExpect(jsonPath("$.textKey").value(DEFAULT_TEXT_KEY))
